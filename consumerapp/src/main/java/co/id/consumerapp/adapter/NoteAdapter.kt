package co.id.consumerapp.adapter
...
import co.id.consumerapp.CustomOnItemClickListener
import co.id.consumerapp.NoteAddUpdateActivity
import co.id.consumerapp.R
